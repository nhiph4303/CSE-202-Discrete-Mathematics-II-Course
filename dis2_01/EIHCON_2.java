...
public class EIHCON_2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < nQueries; ++i) {
            ...
            if (vertexA.adjecenVertices.contains(vertexB)) {
                ...
                for (Vertex vertexC : vertexA.adjecenVertices) {
                    if (vertexC.adjecenVertices.contains(vertexB)) {
                        found = true;
                        break;
                    }
                }
    ...
    static class Vertex {
        ...
        public int id;
        public List<Vertex> adjecenVertices = new ArrayList<Vertex>();
